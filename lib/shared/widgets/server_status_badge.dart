...
import 'package:hermes_mobile/features/status/status_screen.dart';

/// Provider for connection status (simulated for Phase 1).
final serverConnectionProvider = StateProvider<bool>((ref) => false);

/// A badge showing the server connection status.
/// Tap to open the VPS status dashboard.
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(builder: (_) => const VpsStatusScreen()),
        );
      },
      child: Container(
